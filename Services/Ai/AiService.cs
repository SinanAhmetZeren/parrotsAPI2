...
namespace ParrotsAPI2.Services.Ai
{
    public class AiService : IAiService
    {
        ...
        private static string GetSystemPrompt() =>
            ...
            "      * In Major Metropolises (e.g., NYC, London, Berlin, Tokyo): Keep the voyage entirely within the metropolitan area. Treat it as a multi-stage borough-by-borough traversal (50-150+ km total) progressing through distinct outer districts along a continuous corridor. STRICT: Do NOT loop through central tourist staples (e.g., in Berlin, avoid staying trapped between Mitte, Checkpoint Charlie, and Friedrichshain). You MUST push outward into distant or residential quarters (e.g., Wedding, Reinickendorf, Pankow, Weißensee, Lichtenberg). Target: 430–450 words, 4 to 5 paragraphs, 14 to 16 sentences. MANDATORY: If your draft is under 430 words, expand the atmospheric and architectural descriptions of the intermediate neighborhoods until you exceed 430 words.\n" +
            "      * In Small Towns & Rural Hubs (e.g., Moab, St. Andrews): Treat as a long-distance regional trek or pilgrimage (100-300+ km) that exits the town and progresses along regional trails, countryside, and neighboring villages. Target: 430–450 words, 4 to 5 paragraphs, 14 to 16 sentences. MANDATORY: If your draft is under 430 words, expand the atmospheric and architectural descriptions of the intermediate neighborhoods until you exceed 430 words.\n" +
            "    - On Foot (Walk, Run, Hike) + Short Duration (Half day, 1 day): Treat as an exploration within a 2-10 km walking radius depending on duration (shorter 2-4 km radius for half-day, longer 5-10 km radius for 1 full day). Target: 280–300 words, 3 paragraphs, 9 to 11 sentences. MANDATORY: If your draft is under 280 words, expand the atmospheric and architectural descriptions of the intermediate neighborhoods until you exceed 280 words.\n" +
            "    - Motorized & Cycling (Car, Motorcycle, Bicycle, Train) + Long Duration (1 week, 2 weeks): Treat as a multi-city road trip or regional tour covering major transportation corridors, distinct towns, and key regional stops. Target: 430–450 words, 4 to 5 paragraphs, 14 to 16 sentences. MANDATORY: If your draft is under 430 words, expand the atmospheric and architectural descriptions of the intermediate neighborhoods until you exceed 430 words.\n" +
            "    - Motorized & Cycling (Car, Motorcycle, Bicycle, Train) + Short Duration (Half day, 1 day): Treat as a city-wide or regional day loop (covering 10-50+ km). Connect distinct neighborhoods, landmarks, or nearby towns beyond simple walking distance. Target: 280–300 words, 3 paragraphs, 9 to 11 sentences. MANDATORY: If your draft is under 280 words, expand the atmospheric and architectural descriptions of the intermediate neighborhoods until you exceed 280 words.\n" +
