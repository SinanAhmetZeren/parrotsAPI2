...
namespace ParrotsAPI2.Migrations
{
    ...
    [Migration("20260925093437_AddVoyageAdviceColumnsToAskParrotsQueries")]
    partial class AddVoyageAdviceColumnsToAskParrotsQueries
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.AskParrotsQueryEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("FinalSanitizedNarrative")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PlacesApiAuditJson")
                        .HasColumnType("text");

                    b.Property<int>("PlannedSpotCount")
                        .HasColumnType("integer");

                    b.Property<string>("PlannedSpotsJson")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("VoyageAdviceRequestJson")
                        .HasColumnType("text");

                    b.Property<string>("VoyageAdviceResponse")
                        .HasColumnType("text");

                    b.HasKey("Id");

                    b.ToTable("AskParrotsQueries");
                });
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.BlockedEmail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.BlockedUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("BlockerId", "BlockedId", "CreatedAt")
                        .HasDatabaseName("IX_BlockedUsers_BlockerId_BlockedId_CreatedAt");

                    b.ToTable("BlockedUsers");
                });

            modelBuilder.Entity("ParrotsAPI2.Models.CrackerPurchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.CrackerTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.GroupConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.GroupMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.GroupMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("GroupConversationId", "DateTime")
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.UnreadConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("UnreadConversations");
                });

            modelBuilder.Entity("ParrotsAPI2.Models.UserBookmark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("BookmarkedUserId")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("BookmarkerId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.UserReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("ReportedVoyageId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.UserSuspension", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.VoyageUpdate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.GroupMember", b =>
                {
                    b.HasOne("ParrotsAPI2.Models.GroupConversation", "GroupConversation")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.GroupMessage", b =>
                {
                    ...
                    b.HasOne("ParrotsAPI2.Models.AppUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("ParrotsAPI2.Models.AppUser", b =>
                {
                    ...
                    b.Navigation("CrackerPurchases");

                    b.Navigation("CrackerTransactions");
